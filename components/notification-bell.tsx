...
export function NotificationBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        onClick={() => setOpen((o) => !o)}
        className="relative rounded-xl p-2 text-ink/55 transition-colors hover:bg-[var(--app-input-bg)] hover:text-ink/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-brand-500"
      ...
      {open && (
        <div className="glass absolute right-0 z-50 mt-2 w-80 overflow-hidden rounded-2xl border border-[var(--app-border)] shadow-lg">
